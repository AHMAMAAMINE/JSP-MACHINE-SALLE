        ...
        <script src="<%= request.getContextPath()%>/js/datatables-simple-demo.js"></script>
         <script src="<%= request.getContextPath()%>/script/jquery-3.3.1.min.js" type="text/javascript"></script>
        <script src="<%= request.getContextPath()%>/script/MachineSalle.js" type="text/javascript"></script>